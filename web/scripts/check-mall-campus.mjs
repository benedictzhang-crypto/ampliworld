...
assert.equal(blocked(120.5,60),false,'B1 door opens into the new pedestrian concourse');
...
console.log('PASS: 6.25x footprint; 48 bays; 16 cars; continuous courtyard, both indoor doors and ramp; B1 concourse opening; geometric facade.');
