...
export const BUILDING_ASSETS = [
  { id: 'BLD-A01', kind: 'BUILDING', name: 'Helix One', family: 'CYBER FULL-FLOOR TOWER', status: 'LIVE', implementation: 'PROCEDURAL', source: 'game-shell.tsx#SciFiResidenceTower:HELIX', scaleClass: '9 premium levels', notes: 'Rotating floor plates, panoramic glazing and one home per level.' },
  { id: 'BLD-A02', kind: 'BUILDING', name: 'Prism House', family: 'CYBER FULL-FLOOR TOWER', status: 'LIVE', implementation: 'PROCEDURAL', source: 'game-shell.tsx#SciFiResidenceTower:PRISM', scaleClass: '6 double-height tiers', notes: 'Faceted terraces and private sky-garden levels.' },
  { id: 'BLD-A03', kind: 'BUILDING', name: 'Skybridge Residences', family: 'CYBER FULL-FLOOR TOWER', status: 'LIVE', implementation: 'PROCEDURAL', source: 'game-shell.tsx#SciFiResidenceTower:BRIDGE', scaleClass: 'twin 13–15 level towers', notes: 'Twin residential towers connected by private bridge salons.' },
