...
export const METRO_STATIONS = [
  { id: 'M01', name: 'Central Mall', x: 0, z: -68, platformY: -64, mode: 'UNDERGROUND', line: 'A', status: 'SURVEYED' },
  { id: 'M02', name: 'Stadium Gardens', x: -355, z: 700, platformY: -64, mode: 'UNDERGROUND', line: 'A', status: 'SURVEYED' },
  { id: 'M03', name: 'Civic Square', x: 1070, z: 500, platformY: -64, mode: 'UNDERGROUND', line: 'A', status: 'SURVEYED' },
  { id: 'M04', name: 'Medical Campus', x: 3350, z: 4400, platformY: 12, mode: 'ELEVATED', line: 'A', status: 'SURVEYED' },
  { id: 'M05', name: 'East Center', x: 5300, z: 3000, platformY: 12, mode: 'ELEVATED', line: 'A', status: 'SURVEYED' },
  { id: 'M06', name: 'East Bay Marina', x: 6500, z: 12800, platformY: 12, mode: 'ELEVATED', line: 'A', status: 'SURVEYED' },
] as const;
