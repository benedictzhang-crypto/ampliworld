...
export const SOCIAL_JOBS=['酒店前台','销售顾问','客户经理','行政助理','软件工程师','产品经理','设计师','会计','审计员','律师','银行柜员','研究员','医生','护士','药剂师','康复师','教师','幼教老师','图书管理员','实验室技术员','厨师','服务员','咖啡师','调饮师','烘焙师','外卖员','超市理货员','收银员','店长','手机销售顾问','电子产品维修技师','汽车维修技师','理发师','健身教练','保洁员','园林养护员','电工','水管工','维修技师','建筑工人','塔吊司机','水泥搅拌车司机','环卫工人','垃圾车司机','焚烧炉操作员','电力运行员','电网调度员','税务审查员','纳税服务专员','公交司机','出租车司机','网约车司机','货车司机','配送员','仓库管理员','机场地勤','机场安检员','地铁安检员','地铁运营员','物业管家','保安','警员','消防员','社工','照护员','摄影师','音乐教师','创业者','自由职业者','全职家庭照护者','求职者'];
