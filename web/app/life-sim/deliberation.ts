...
export function validateDecision(w:LifeWorld,id:string,value:unknown):Decision{
 ...
 if(!v||!['eat','rest','leisure','travel','shop','work','home'].includes(String(v.action))||typeof v.reason!=='string'||v.reason.length>240)throw Error('模型行动格式无效');
