...
const dictionary:Record<string,string>={
 ...
 '每名居民是独立个体，同一家人各有个人账户。初始财富差异借用美国家庭统计作为情景参考，并非已校准的个人财富分布；旧存档保留既有财产。当前全城有 30,000 条持久居民记录，不代表 30,000 个大模型同时推理。':'Each resident is an individual with a separate account. Initial wealth differences use U.S. household statistics only as a scenario reference, not as calibrated individual wealth. Existing saves retain their assets. The city has 30,000 persistent resident records, not 30,000 simultaneous LLM processes.',
 '压力（越低越好）':'Stress (lower is better)','水果与生鲜店':'Fruit & fresh market',
 ...
 '医院行政主管':'Hospital administrator','医院前台':'Hospital receptionist','医学检验技师':'Medical laboratory technologist','影像技师':'Medical imaging technologist','急救员':'Paramedic','康复治疗师':'Rehabilitation therapist','医院后勤人员':'Hospital operations worker','医院保安':'Hospital security officer',
 '警务主管':'Police supervisor','巡逻警员':'Patrol officer','交通警员':'Traffic enforcement officer','刑事调查员':'Detective','警务调度员':'Police dispatcher','警务档案员':'Police records clerk','警局保洁员':'Police station cleaner',
 '餐厅经营者':'Restaurateur','餐厅接待员':'Restaurant host','洗碗工':'Dishwasher','餐厅保洁员':'Restaurant cleaner','备餐员':'Prep cook','酒吧经理':'Bar manager','调酒师':'Bartender','酒吧服务员':'Bar server','酒吧保安':'Bar security officer','洗杯员':'Glass washer','酒吧保洁员':'Bar cleaner','夜店经理':'Nightclub manager','夜店服务员':'Nightclub server','夜店保安':'Nightclub security officer','夜店保洁员':'Nightclub cleaner',
 '干洗店经理':'Dry-cleaning manager','干洗技师':'Dry-cleaning technician','熨烫整形员':'Pressing specialist','衣物修补员':'Garment repair specialist','干洗店前台':'Dry-cleaning counter associate','自助洗衣店经理':'Laundromat manager','洗衣店值班员':'Laundromat attendant','洗衣设备维护员':'Laundry equipment technician',
 '银行网点经理':'Bank branch manager','信贷专员':'Loan officer','银行客服':'Bank customer service representative','银行保安':'Bank security officer','银行保洁员':'Bank cleaner',
 '水务公司主管':'Water utility supervisor','水处理操作员':'Water treatment operator','水质检验员':'Water quality analyst','供水管网维修员':'Water network technician','水务工程师':'Water engineer','水务调度员':'Water dispatch operator','污水处理厂主管':'Wastewater plant supervisor','污水处理操作员':'Wastewater treatment operator','环境检验员':'Environmental laboratory analyst','排水管网维修员':'Sewer network technician','污泥处理员':'Biosolids operator',
 '市政厅行政主管':'City Hall administrator','城市规划师':'Urban planner','行政审批员':'Permitting officer','民政服务专员':'Civil services officer','政府采购专员':'Public procurement officer','市政档案员':'Municipal records officer','政务服务人员':'Civic services representative','法院行政主管':'Court administrator','法官':'Judge','检察官':'Prosecutor','公设辩护人':'Public defender','法庭书记员':'Court clerk','法警':'Court officer','法律援助专员':'Legal aid officer','法院档案员':'Court records officer',
 '急救中心主管':'EMS supervisor','急救调度员':'Emergency medical dispatcher','救护车司机':'Ambulance driver','救护车维修技师':'Ambulance technician','道路交通管理局主管':'Roads and transportation director','道路养护工':'Road maintenance worker','交通信号技师':'Traffic signal technician','停车执法员':'Parking enforcement officer','拖车司机':'Tow-truck driver','交通规划师':'Transportation planner','桥梁巡检员':'Bridge inspector','道路调度员':'Road operations dispatcher',
 '校长':'Principal','教学助理':'Teaching assistant','学校心理辅导员':'School counselor','学校行政人员':'School administrator','校园餐饮员工':'School food-service worker','校园保洁员':'School cleaner','校园保安':'School security officer',
 '酒店经理':'Hotel manager','客房保洁员':'Housekeeper','礼宾员':'Concierge','汽车中心经理':'Dealership manager','汽车销售顾问':'Automotive sales adviser','零售顾问':'Retail adviser','物业经理':'Property manager','超市店长':'Supermarket manager',
