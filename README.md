...
**Unified residents — 14 September:** 300 persisted individuals now share one identity, street instance, family, personality and financial record. Existing resident IDs, savings, holdings, asset valuations and debt survive migration. There is no separate 30,000-person decorative registry; tens of thousands of CBD residents remains the scaling target. Each record has a simulated bank account; itemized property ownership and loan servicing remain pending. See `web/docs/unified-residents-2026-09-14.md`. This supersedes the earlier 100 household-representative interpretation below.
